"""
Pedestrian Behavior Classification Head.
Phase 19 of implementation plan:
Task A: Recognizes 8 fine-grained pedestrian behaviors:
...
class PedestrianBehaviorHead(nn.Module):
    def __init__(
        self,
        feature_dim: int = 256,
        num_classes: int = len(PEDESTRIAN_CLASSES),
        dropout: float = 0.1,
